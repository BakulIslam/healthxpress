    ...
    <div class="card">
        <div class="card-header border-bottom bg-primary d-flex py-3">
            ...
            <div class="w-50 my-auto text-end">
                <a href="<?php echo e(route('product.create')); ?>" type="button" id="addBrandModalBtn" class=" btn btn-light px-2" style=""><i style="margin-top: -2px; margin-right: 4px;" class='bx bxs-plus-circle'></i> Add New</a>
            </div>
        </div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        function product_index(id){
            var url = "<?php echo e(route('product.indexing', ':id')); ?>";
            url = url.replace(':id', id);
            $.ajax({
                type: "GET",
                url: url,
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\medi-world-app\resources\views/admin/pages/products/products.blade.php ENDPATH**/ ?>