...
<script src="<?php echo e(asset('frontend/assets/js/jquery.knob.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/assets/js/jquery.counterup.min.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/assets/js/jquery.scrollUp.min.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\medi-world-app\resources\views/layouts/frontend/script.blade.php ENDPATH**/ ?>