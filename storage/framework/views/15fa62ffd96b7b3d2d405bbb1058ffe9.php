<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item <?php echo e(Request::is('admin/categories') ? 'open active' : ''); ?>  <?php echo e(Request::is('admin/sub-categories') ? 'open active' : ''); ?>">
        ...
        <ul class="menu-sub">
          <li class="menu-item <?php echo e(Request::is('admin/categories') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('categories')); ?>" class="menu-link">
              <div data-i18n="Account">Categroy List</div>
            </a>
          </li>
          <li class="menu-item <?php echo e(Request::is('admin/sub-categories') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('subcategories')); ?>" class="menu-link">
      ...
      <li class="menu-item <?php echo e(Request::is('admin/brands') ? 'open active' : ''); ?>  <?php echo e(Request::is('admin/origin') ? 'open active' : ''); ?>">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class="menu-icon tf-icons bx bx-dock-top"></i>
          <div data-i18n="Account Settings">Brand & Assembly & Origin</div>
        </a>
        <ul class="menu-sub">
            <li class="menu-item <?php echo e(Request::is('admin/brands') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('brand.index')); ?>" class="menu-link">
                  <div data-i18n="Notifications">Brand List</div>
                </a>
            </li>
            <li class="menu-item <?php echo e(Request::is('admin/origin') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('origin.index')); ?>" class="menu-link">
      ...
      <!-- Cards -->
      <li class="menu-item <?php echo e(Request::is('admin/product*') ? 'open active' : ''); ?>">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class="menu-icon tf-icons bx bx-dock-top"></i>
       ...
       <!-- Cards -->
       <li class="menu-item <?php echo e(Request::is('admin/settings*') ? 'open active' : ''); ?>">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class="menu-icon tf-icons bx bx-dock-top"></i>
        ...
        <ul class="menu-sub">
          ...
          <li class="menu-item <?php echo e(Request::is('admin/settings/pages/about-us') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('settings.pages.about.index')); ?>" class="menu-link">
              <div data-i18n="Account">About Us Page</div>
            </a>
          </li>
          <li class="menu-item <?php echo e(Request::is('admin/settings/pages/director-message') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('settings.pages.director_message.index')); ?>" class="menu-link">
  ...
  <!-- <?php echo e(route('product.index')); ?> -->
            <!-- <?php echo e(route('product.reagent.create')); ?> --><?php /**PATH C:\xampp\htdocs\medi-world-app\resources\views/layouts/admin/sidebar.blade.php ENDPATH**/ ?>