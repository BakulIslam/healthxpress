...
<?php echo $__env->make('admin.modals.add-categroy', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        function edit(id){
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#image').val('');
                    $('#image_id').attr("src", "<?php echo e(asset('uploads/category')); ?>/" + data.image);
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\medi-world-app\resources\views/admin/pages/category.blade.php ENDPATH**/ ?>