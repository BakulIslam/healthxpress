...
<?php echo $__env->make('admin.modals.add-sub-categroy', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        function UpdateSubCategory(){
            ...
            var url = '<?php echo e(route('subcategory.update', ':id')); ?>';
        ...
        // Category Delete
        function destroy(id){
            var url = "<?php echo e(route('subcategory.destroy', ':id')); ?>";
            url = url.replace(':id', id);
            Swal.fire({
                title: "Are you sure?",
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\medi-world-app\resources\views/admin/pages/sub-category.blade.php ENDPATH**/ ?>