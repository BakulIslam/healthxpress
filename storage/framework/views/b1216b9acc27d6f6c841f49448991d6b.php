            ...
            <div class="modal-body">
                ...
                <div class="row d-none">
                    <div class="col mb-3">
                        ...
                        <input type="text" id="sub_slug" name="sub_slug" class="form-control" value="<?php echo e(old('slug')); ?>" placeholder="Enter Sub Category Slug" />
                    </div>
                </div>
                <div class="row mt-4">
    ...
    <script>
        ...
        function addSubCategory(){
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('subcategory.store')); ?>",
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\medi-world-app\resources\views/admin/modals/add-sub-categroy.blade.php ENDPATH**/ ?>