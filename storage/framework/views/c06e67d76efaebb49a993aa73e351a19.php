...
<style>
  ...
  <div class="contact-area pos-rel pt-100 pb-160">
    <div class="shape d-none d-xl-block">
        <div class="shape-item con-01"><img src="<?php echo e(asset('forntend/assets/img/icon/s.png')); ?>" alt=""></div>
    </div>
    <div class="container">
        <div class="row">
                    ...
                    <ul class="contact-address-link">
                        <li>
                            ...
                            <div class="contact-address-text">
                                ...
                                <h4 class="text-capitalize"><?php echo companyInfo()->address; ?></h4>
                            </div>
                        </li>
                        <li>
                            <div class="contact-address-icon f-left mr-25">
...
<?php echo $__env->make('layouts.frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\medi-world-app\resources\views/frontend/contact.blade.php ENDPATH**/ ?>