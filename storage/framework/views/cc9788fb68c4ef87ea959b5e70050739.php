...
<?php echo $__env->make('admin.modals.add-origin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        // Get Data For Edit
        function edit(id){
            var url = "<?php echo e(route('origin.edit', ':id')); ?>";
        ...
        function UpdateOrigin(){
            ...
            var url = '<?php echo e(route('origin.update', ':id')); ?>';
        ...
        // Delete
        function destroy(id){
            var url = "<?php echo e(route('origin.destroy', ':id')); ?>";
            url = url.replace(':id', id);
            Swal.fire({
                title: "Are you sure?",
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\medi-world-app\resources\views/admin/pages/origin.blade.php ENDPATH**/ ?>